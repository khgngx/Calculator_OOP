package com.khgngx.calculator.UI;

import com.khgngx.calculator.Theme.Properties.Theme;
import com.khgngx.calculator.Theme.ThemeLoader;
import com.khgngx.calculator.util.ColorUtil;
...
public class CalculatorUI {
    ...
    private void initButtons(int[] columns, int[] rows) {
        ...
        btnBack = createButton("Del", columns[1], rows[1]);
        ...
        btnPower.setFont(new Font("Times New Roman", Font.PLAIN, 25));
        btnPower.setVisible(false);
